  ...
  return (
    <div className="min-h-screen bg-white flex flex-col font-sans select-none">
      ...
      <main className="flex-grow section-viewport flex flex-col justify-center pt-16 md:pt-24 pb-28 px-6 md:px-12 max-w-7xl mx-auto w-full text-left">
        ...
        <p className="font-assistant text-[14px] md:text-[15px] leading-relaxed text-[#121212]/70 font-light mb-12 max-w-2xl">
        ...
        <div className="flex flex-wrap gap-x-12 md:gap-x-16 gap-y-6 items-center">
          ...
          <a
            href="mailto:hello@gourmethouse.com"
          ...
          >
            ...
            <span className="font-sans text-[11px] font-semibold uppercase tracking-[2px] text-gh-dark underline underline-offset-[8px] decoration-[0.5px] group-hover:text-gh-gold group-hover:decoration-gh-gold transition-colors duration-300">
              HELLO@GOURMETHOUSE.COM &gt;
            </span>
          </a>

          <a
            href="https://wa.me/447960000000"
            target="_blank"
